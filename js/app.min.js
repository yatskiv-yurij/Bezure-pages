...
(function () {
  ...
  function t(i, r) {
    void 0 === i && (i = {}), void 0 === r && (r = {}), Object.keys(r).forEach(function (n) {
  ...
  function f(e, t) {
    ...
    } else if (e.nodeType || e === i || e === n) a.push(e);else if (Array.isArray(e)) {
  ...
  var g = {
    ...
    on: function on() {
      ...
      function o(e) {
        ...
        if (t) {
          ...
          if (i.indexOf(e) < 0 && i.unshift(e), f(t).is(n)) s.apply(t, i);else for (var r = f(t).parents(), a = 0; a < r.length; a += 1) {
    ...
    off: function off() {
      ...
      for (var o = r.split(" "), l = 0; l < o.length; l += 1) {
        for (var d = o[l], u = 0; u < this.length; u += 1) {
          var c = this[u],
              p = void 0;
          if (!n && c.dom7Listeners ? p = c.dom7Listeners[d] : n && c.dom7LiveListeners && (p = c.dom7LiveListeners[d]), p && p.length) for (var v = p.length - 1; v >= 0; v -= 1) {
            var f = p[v];
            s && f.listener === s || s && f.listener && f.listener.dom7proxy && f.listener.dom7proxy === s ? (c.removeEventListener(d, f.proxyListener, a), p.splice(v, 1)) : s || (c.removeEventListener(d, f.proxyListener, a), p.splice(v, 1));
          }
        }
      }
    ...
    nextAll: function nextAll(e) {
      ...
      for (; i.nextElementSibling;) {
        ...
        e ? f(r).is(e) && t.push(r) : t.push(r), i = r;
      }
  ...
  function E() {
    for (var e = Object(arguments.length <= 0 ? void 0 : arguments[0]), t = ["__proto__", "constructor", "prototype"], i = 1; i < arguments.length; i += 1) {
      ...
      if (null != r && !C(r)) for (var n = Object.keys(Object(r)).filter(function (e) {
        return t.indexOf(e) < 0;
      }), s = 0, a = n.length; s < a; s += 1) {
        var o = n[s],
            l = Object.getOwnPropertyDescriptor(r, o);
        void 0 !== l && l.enumerable && (S(e[o]) && S(r[o]) ? r[o].__swiper__ ? e[o] = r[o] : E(e[o], r[o]) : !S(e[o]) && S(r[o]) ? (e[o] = {}, r[o].__swiper__ ? e[o] = r[o] : E(e[o], r[o])) : e[o] = r[o]);
      }
    }
  ...
  function y(e, t) {
    Object.keys(t).forEach(function (i) {
      S(t[i]) && Object.keys(t[i]).forEach(function (r) {
    ...
    return void 0 === e && (e = {}), M || (M = function (e) {
      var t = (void 0 === e ? {} : e).userAgent,
        ...
        android: !1
          ...
          f = "Win32" === n,
          h = "MacIntel" === n;
      return !c && h && i.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(l + "x" + d) >= 0 && ((c = a.match(/(Version)\/([\d.]+)/)) || (c = [0, 1, "13_0_0"]), h = !1), u && !f && (o.os = "android", o.android = !0), (c || v || p) && (o.os = "ios", o.ios = !0), o;
    }(e)), M;
  }
  ...
  var D = {
    ...
    updateSlides: function updateSlides() {
      ...
      if (void 0 !== s) {
        var y, x;
        "string" == typeof T && T.indexOf("%") >= 0 && (T = parseFloat(T.replace("%", "")) / 100 * s), e.virtualSize = -T, a ? u.css({
          marginLeft: "",
          marginBottom: "",
          marginTop: ""
        }) : u.css({
          ...
          marginBottom: "",
          marginTop: ""
        }), r.slidesPerColumn > 1 && (y = Math.floor(c / r.slidesPerColumn) === c / e.params.slidesPerColumn ? c : Math.ceil(c / r.slidesPerColumn) * r.slidesPerColumn, "auto" !== r.slidesPerView && "row" === r.slidesPerColumnFill && (y = Math.max(y, r.slidesPerView * r.slidesPerColumn)));

        for (var M, P, k, L = r.slidesPerColumn, O = y / L, A = Math.floor(c / r.slidesPerColumn), z = 0; z < c; z += 1) {
          x = 0;
          var I = u.eq(z);
          ...
          if (r.slidesPerColumn > 1) {
            ...
            if ("row" === r.slidesPerColumnFill && r.slidesPerGroup > 1) {
              var N = Math.floor(z / (r.slidesPerGroup * r.slidesPerColumn)),
                  ...
                  j = 0 === N ? r.slidesPerGroup : Math.min(Math.ceil((c - N * L * r.slidesPerGroup) / L), r.slidesPerGroup);

              D = (B = _ - (G = Math.floor(_ / j)) * j + N * r.slidesPerGroup) + G * y / L, I.css({
            ...
            } else "column" === r.slidesPerColumnFill ? (G = z - (B = Math.floor(z / L)) * L, (B > A || B === A && G === L - 1) && (G += 1) >= L && (G = 0, B += 1)) : B = z - (G = Math.floor(z / O)) * O;
          ...
          if ("none" !== I.css("display")) {
            if ("auto" === r.slidesPerView) {
              var H = getComputedStyle(I[0]),
                  V = I[0].style.transform,
                  $ = I[0].style.webkitTransform;
              if (V && (I[0].style.transform = "none"), $ && (I[0].style.webkitTransform = "none"), r.roundLengths) x = e.isHorizontal() ? I.outerWidth(!0) : I.outerHeight(!0);else {
                var R = i(H, "width"),
                    W = i(H, "padding-left"),
                    F = i(H, "padding-right"),
                    q = i(H, "margin-left"),
                ...
                if (Y && "border-box" === Y) x = R + q + X;else {
                  var U = I[0],
                      K = U.clientWidth;
                  x = R + W + F + q + X + (U.offsetWidth - K);
                }
              }
              V && (I[0].style.transform = V), $ && (I[0].style.webkitTransform = $), r.roundLengths && (x = Math.floor(x));
            } else x = (s - (r.slidesPerView - 1) * T) / r.slidesPerView, r.roundLengths && (x = Math.floor(x)), u[z] && (u[z].style[t("width")] = x + "px");

            u[z] && (u[z].swiperSlideSize = x), f.push(x), r.centeredSlides ? (b = b + x / 2 + S / 2 + T, 0 === S && 0 !== z && (b = b - s / 2 - T), 0 === z && (b = b - s / 2 - T), Math.abs(b) < .001 && (b = 0), r.roundLengths && (b = Math.floor(b)), C % r.slidesPerGroup == 0 && p.push(b), v.push(b)) : (r.roundLengths && (b = Math.floor(b)), (C - Math.min(e.params.slidesPerGroupSkip, C)) % e.params.slidesPerGroup == 0 && p.push(b), v.push(b), b = b + x + T), e.virtualSize += x + T, S = x, C += 1;
          }
        }

        if (e.virtualSize = Math.max(e.virtualSize, s) + m, a && o && ("slide" === r.effect || "coverflow" === r.effect) && n.css({
          width: e.virtualSize + r.spaceBetween + "px"
        }), r.setWrapperSize && n.css(((P = {})[t("width")] = e.virtualSize + r.spaceBetween + "px", P)), r.slidesPerColumn > 1 && (e.virtualSize = (x + r.spaceBetween) * y, e.virtualSize = Math.ceil(e.virtualSize / r.slidesPerColumn) - r.spaceBetween, n.css(((k = {})[t("width")] = e.virtualSize + r.spaceBetween + "px", k)), r.centeredSlides)) {
          M = [];

          for (var J = 0; J < p.length; J += 1) {
            var Q = p[J];
            r.roundLengths && (Q = Math.floor(Q)), p[J] < e.virtualSize + p[0] && M.push(Q);
          }
        ...
        if (!r.centeredSlides) {
          ...
          for (var Z = 0; Z < p.length; Z += 1) {
            var ee = p[Z];
            r.roundLengths && (ee = Math.floor(ee)), p[Z] <= e.virtualSize - s && M.push(ee);
          }
        ...
        E(e, {
          ...
          slidesGrid: v,
          slidesSizesGrid: f
        }), c !== d && e.emit("slidesLengthChange"), p.length !== g && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), v.length !== w && e.emit("slidesGridLengthChange"), (r.watchSlidesProgress || r.watchSlidesVisibility) && e.updateSlidesOffset();
      }
    },
      ...
      if (0 !== r.length) {
        ...
        for (var a = 0; a < r.length; a += 1) {
          ...
          if (i.watchSlidesVisibility || i.centeredSlides && i.autoHeight) {
            ...
            (d >= 0 && d < t.size - 1 || u > 1 && u <= t.size || d <= 0 && u >= t.size) && (t.visibleSlides.push(o), t.visibleSlidesIndexes.push(a), r.eq(a).addClass(i.slideVisibleClass));
          }
    ...
    updateProgress: function updateProgress(e) {
      ...
      var r = t.params,
          ...
          l = a,
          d = o;
      0 === n ? (s = 0, a = !0, o = !0) : (a = (s = (e - t.minTranslate()) / n) <= 0, o = s >= 1), E(t, {
        progress: s,
        isBeginning: a,
        isEnd: o
    ...
    updateClickedSlide: function updateClickedSlide(e) {
      var t,
          i = this,
          r = i.params,
          n = w(e.target).closest("." + r.slideClass)[0],
          s = !1;
      if (n) for (var a = 0; a < i.slides.length; a += 1) {
        if (i.slides[a] === n) {
          s = !0, t = a;
          break;
        }
      ...
      i.clickedSlide = n, i.virtual && i.params.virtual.enabled ? i.clickedIndex = parseInt(w(n).attr("data-swiper-slide-index"), 10) : i.clickedIndex = t, r.slideToClickedSlide && void 0 !== i.clickedIndex && i.clickedIndex !== i.activeIndex && i.slideToClickedSlide();
    }
  },
      N = {
    slideTo: function slideTo(e, t, i, r, n) {
      ...
      g >= d.length && (g = d.length - 1), (p || l.initialSlide || 0) === (c || 0) && i && a.emit("beforeSlideChangeStart");
      var w,
          T = -d[g];
      if (a.updateProgress(T), l.normalizeSlideIndex) for (var b = 0; b < u.length; b += 1) {
        var S = -Math.floor(100 * T),
            C = Math.floor(100 * u[b]),
            E = Math.floor(100 * u[b + 1]);
        void 0 !== u[b + 1] ? S >= C && S < E - (E - C) / 2 ? o = b : S >= C && S < E && (o = b + 1) : S >= C && (o = b);
      }

      if (a.initialized && o !== p) {
        if (!a.allowSlideNext && T < a.translate && T < a.minTranslate()) return !1;
        if (!a.allowSlidePrev && T > a.translate && T > a.maxTranslate() && (p || 0) !== o) return !1;
      }

      if (w = o > p ? "next" : o < p ? "prev" : "reset", v && -T === a.translate || !v && T === a.translate) return a.updateActiveIndex(o), l.autoHeight && a.updateAutoHeight(), a.updateSlidesClasses(), "slide" !== l.effect && a.setTranslate(T), "reset" !== w && (a.transitionStart(i, w), a.transitionEnd(i, w)), !1;

      if (l.cssMode) {
        var y,
            x = a.isHorizontal(),
            M = -T;
        return v && (M = f.scrollWidth - f.offsetWidth - M), 0 === t ? f[x ? "scrollLeft" : "scrollTop"] = M : f.scrollTo ? f.scrollTo(((y = {})[x ? "left" : "top"] = M, y.behavior = "smooth", y)) : f[x ? "scrollLeft" : "scrollTop"] = M, !0;
      }
    ...
    slidePrev: function slidePrev(e, t, i) {
      ...
      return void 0 === v && n.cssMode && a.forEach(function (e) {
        !v && c >= e && (v = e);
      }), void 0 !== v && (u = o.indexOf(v)) < 0 && (u = r.activeIndex - 1), r.slideTo(u, e, t, i);
    },
    ...
    slideToClickedSlide: function slideToClickedSlide() {
      ...
      if (i.loop) {
        ...
        e = parseInt(w(t.clickedSlide).attr("data-swiper-slide-index"), 10), i.centeredSlides ? s < t.loopedSlides - n / 2 || s > t.slides.length - t.loopedSlides + n / 2 ? (t.loopFix(), s = r.children("." + i.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + i.slideDuplicateClass + ")").eq(0).index(), T(function () {
          t.slideTo(s);
        })) : t.slideTo(s) : s > t.slides.length - n ? (t.loopFix(), s = r.children("." + i.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + i.slideDuplicateClass + ")").eq(0).index(), T(function () {
          t.slideTo(s);
        })) : t.slideTo(s);
      } else t.slideTo(s);
    }
    ...
    loopCreate: function loopCreate() {
      ...
      s.each(function (t, i) {
        var r = w(t);
        i < e.loopedSlides && u.push(t), i < s.length && i >= s.length - e.loopedSlides && d.push(t), r.attr("data-swiper-slide-index", i);
      });

      for (var c = 0; c < u.length; c += 1) {
        n.append(w(u[c].cloneNode(!0)).addClass(i.slideDuplicateClass));
      }

      for (var p = d.length - 1; p >= 0; p -= 1) {
        n.prepend(w(d[p].cloneNode(!0)).addClass(i.slideDuplicateClass));
      }
    },
  ...
  function j(e) {
    ...
    if (t.enabled && (!t.animating || !o.preventInteractionOnTransition)) {
      ...
      if (("wrapper" !== o.touchEventsTarget || u.closest(t.wrapperEl).length) && (a.isTouchEvent = "touchstart" === d.type, (a.isTouchEvent || !("which" in d) || 3 !== d.which) && !(!a.isTouchEvent && "button" in d && d.button > 0 || a.isTouched && a.isMoved))) {
        o.noSwipingClass && "" !== o.noSwipingClass && d.target && d.target.shadowRoot && e.path && e.path[0] && (u = w(e.path[0]));
        var c = o.noSwipingSelector ? o.noSwipingSelector : "." + o.noSwipingClass,
            p = !(!d.target || !d.target.shadowRoot);
        if (o.noSwiping && (p ? function (e, t) {
          return void 0 === t && (t = this), function t(i) {
            return i && i !== r() && i !== s() ? (i.assignedSlot && (i = i.assignedSlot), i.closest(e) || t(i.getRootNode().host)) : null;
          }(t);
        }(c, d.target) : u.closest(c)[0])) t.allowClick = !0;else if (!o.swipeHandler || u.closest(o.swipeHandler)[0]) {
          ...
          if (E(a, {
            ...
            isScrolling: void 0,
            startMoving: void 0
          }), l.startX = v, l.startY = f, a.touchStartTime = b(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, o.threshold > 0 && (a.allowThresholdMove = !1), "touchstart" !== d.type) {
            var g = !0;
            u.is(a.focusableElements) && (g = !1), i.activeElement && w(i.activeElement).is(a.focusableElements) && i.activeElement !== u[0] && i.activeElement.blur();
            var T = g && t.allowTouchMove && o.touchStartPreventDefault;
            !o.touchStartForcePreventDefault && !T || u[0].isContentEditable || d.preventDefault();
          }
    ...
    if (i.enabled) {
      ...
      if (l.originalEvent && (l = l.originalEvent), n.isTouched) {
        if (!n.isTouchEvent || "touchmove" === l.type) {
          ...
          if (!i.allowTouchMove) return i.allowClick = !1, void (n.isTouched && (E(a, {
            startX: u,
            startY: c,
            currentX: u,
            currentY: c
          ...
          if (n.isTouchEvent && t.activeElement && l.target === t.activeElement && w(l.target).is(n.focusableElements)) return n.isMoved = !0, void (i.allowClick = !1);

          if (n.allowTouchCallbacks && i.emit("touchMove", l), !(l.targetTouches && l.targetTouches.length > 1)) {
            a.currentX = u, a.currentY = c;
            var p,
                v = a.currentX - a.startX,
                f = a.currentY - a.startY;
            if (!(i.params.threshold && Math.sqrt(Math.pow(v, 2) + Math.pow(f, 2)) < i.params.threshold)) if (void 0 === n.isScrolling && (i.isHorizontal() && a.currentY === a.startY || i.isVertical() && a.currentX === a.startX ? n.isScrolling = !1 : v * v + f * f >= 25 && (p = 180 * Math.atan2(Math.abs(f), Math.abs(v)) / Math.PI, n.isScrolling = i.isHorizontal() ? p > s.touchAngle : 90 - p > s.touchAngle)), n.isScrolling && i.emit("touchMoveOpposite", l), void 0 === n.startMoving && (a.currentX === a.startX && a.currentY === a.startY || (n.startMoving = !0)), n.isScrolling) n.isTouched = !1;else if (n.startMoving) {
              ...
              var h = i.isHorizontal() ? v : f;
              a.diff = h, h *= s.touchRatio, o && (h = -h), i.swipeDirection = h > 0 ? "prev" : "next", n.currentTranslate = h + n.startTranslate;
              var m = !0,
                  g = s.resistanceRatio;
  ...
  function V(e) {
    ...
    if (t.enabled) {
      ...
      if (t.allowClick && (t.updateClickedSlide(d), t.emit("tap click", d), p < 300 && c - i.lastClickTime < 300 && t.emit("doubleTap doubleClick", d)), i.lastClickTime = b(), T(function () {
      ...
      if (i.isTouched = !1, i.isMoved = !1, i.startMoving = !1, u = r.followFinger ? s ? t.translate : -t.translate : -i.currentTranslate, !r.cssMode) if (r.freeMode) {
        ...
        if (r.freeModeMomentum) {
          if (i.velocities.length > 1) {
            var v = i.velocities.pop(),
                ...
                m = v.time - f.time;
            t.velocity = h / m, t.velocity /= 2, Math.abs(t.velocity) < r.freeModeMinimumVelocity && (t.velocity = 0), (m > 150 || b() - v.time > 300) && (t.velocity = 0);
          } else t.velocity = 0;
          ...
          if (S < t.maxTranslate()) r.freeModeMomentumBounce ? (S + t.maxTranslate() < -x && (S = t.maxTranslate() - x), C = t.maxTranslate(), y = !0, i.allowMomentumBounce = !0) : S = t.maxTranslate(), r.loop && r.centeredSlides && (E = !0);else if (S > t.minTranslate()) r.freeModeMomentumBounce ? (S - t.minTranslate() > x && (S = t.minTranslate() + x), C = t.minTranslate(), y = !0, i.allowMomentumBounce = !0) : S = t.minTranslate(), r.loop && r.centeredSlides && (E = !0);else if (r.freeModeSticky) {
            ...
            S = -(S = Math.abs(l[M] - S) < Math.abs(l[M - 1] - S) || "next" === t.swipeDirection ? l[M] : l[M - 1]);
          }

          if (E && t.once("transitionEnd", function () {
            t.loopFix();
          }), 0 !== t.velocity) {
            if (g = s ? Math.abs((-S - t.translate) / t.velocity) : Math.abs((S - t.translate) / t.velocity), r.freeModeSticky) {
              var k = Math.abs((s ? -S : S) - t.translate),
                  L = t.slidesSizesGrid[t.activeIndex];
              g = k < L ? r.speed : k < 2 * L ? 1.5 * r.speed : 2.5 * r.speed;
            }
          } else if (r.freeModeSticky) return void t.slideToClosest();

          r.freeModeMomentumBounce && y ? (t.updateProgress(C), t.setTransition(g), t.setTranslate(S), t.transitionStart(!0, t.swipeDirection), t.animating = !0, a.transitionEnd(function () {
        ...
        for (var O = 0, A = t.slidesSizesGrid[0], z = 0; z < o.length; z += z < r.slidesPerGroupSkip ? 1 : r.slidesPerGroup) {
          ...
          void 0 !== o[z + I] ? u >= o[z] && u < o[z + I] && (O = z, A = o[z + I] - o[z]) : u >= o[z] && (O = z, A = o[o.length - 1] - o[o.length - 2]);
        }
        ...
        if (p > r.longSwipesMs) {
          ...
          "next" === t.swipeDirection && (D >= r.longSwipesRatio ? t.slideTo(O + B) : t.slideTo(O)), "prev" === t.swipeDirection && (D > 1 - r.longSwipesRatio ? t.slideTo(O + B) : t.slideTo(O));
        } else {
          if (!r.shortSwipes) return void t.slideTo(t.activeIndex);
          !t.navigation || d.target !== t.navigation.nextEl && d.target !== t.navigation.prevEl ? ("next" === t.swipeDirection && t.slideTo(O + B), "prev" === t.swipeDirection && t.slideTo(O)) : d.target === t.navigation.nextEl ? t.slideTo(O + B) : t.slideTo(O);
        }
      }
    }
  }
  ...
  var X = {
    attachEvents: function attachEvents() {
      var e = this,
          ...
          o = e.device,
          l = e.support;
      e.onTouchStart = j.bind(e), e.onTouchMove = H.bind(e), e.onTouchEnd = V.bind(e), i.cssMode && (e.onScroll = W.bind(e)), e.onClick = R.bind(e);
      var d = !!i.nested;
      if (!l.touch && l.pointerEvents) s.addEventListener(n.start, e.onTouchStart, !1), t.addEventListener(n.move, e.onTouchMove, d), t.addEventListener(n.end, e.onTouchEnd, !1);else {
        if (l.touch) {
          ...
          s.addEventListener(n.start, e.onTouchStart, u), s.addEventListener(n.move, e.onTouchMove, l.passiveListener ? {
            passive: !1,
            capture: d
          } : d), s.addEventListener(n.end, e.onTouchEnd, u), n.cancel && s.addEventListener(n.cancel, e.onTouchEnd, u), F || (t.addEventListener("touchstart", q), F = !0);
        }
      ...
      (i.preventClicks || i.preventClicksPropagation) && s.addEventListener("click", e.onClick, !0), i.cssMode && a.addEventListener("scroll", e.onScroll), i.updateOnWindowResize ? e.on(o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", $, !0) : e.on("observerUpdate", $, !0);
    },
    detachEvents: function detachEvents() {
      ...
      if (!l.touch && l.pointerEvents) s.removeEventListener(n.start, e.onTouchStart, !1), t.removeEventListener(n.move, e.onTouchMove, d), t.removeEventListener(n.end, e.onTouchEnd, !1);else {
        if (l.touch) {
          ...
          s.removeEventListener(n.start, e.onTouchStart, u), s.removeEventListener(n.move, e.onTouchMove, d), s.removeEventListener(n.end, e.onTouchEnd, u), n.cancel && s.removeEventListener(n.cancel, e.onTouchEnd, u);
        }
      ...
      (i.preventClicks || i.preventClicksPropagation) && s.removeEventListener("click", e.onClick, !0), i.cssMode && a.removeEventListener("scroll", e.onScroll), e.off(o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", $);
    }
  },
      Y = {
  ...
  var J = {
      ...
      getTranslate: function getTranslate(e) {
        ...
        var o = function (e, t) {
          ...
          return a.WebKitCSSMatrix ? ((r = o.transform || o.webkitTransform).split(",").length > 6 && (r = r.split(", ").map(function (e) {
            return e.replace(",", ".");
          }).join(", ")), n = new a.WebKitCSSMatrix("none" === r ? "" : r)) : i = (n = o.MozTransform || o.OTransform || o.MsTransform || o.msTransform || o.transform || o.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,")).toString().split(","), "x" === t && (r = a.WebKitCSSMatrix ? n.m41 : 16 === i.length ? parseFloat(i[12]) : parseFloat(i[4])), "y" === t && (r = a.WebKitCSSMatrix ? n.m42 : 16 === i.length ? parseFloat(i[13]) : parseFloat(i[5])), r || 0;
        }(a[0], e);
    ...
    manipulation: {
      appendSlide: function appendSlide(e) {
        var t = this,
            i = t.$wrapperEl,
            r = t.params;
        if (r.loop && t.loopDestroy(), "object" == _typeof(e) && "length" in e) for (var n = 0; n < e.length; n += 1) {
          e[n] && i.append(e[n]);
        } else i.append(e);
        ...
        if (o && (!o || 0 !== Object.keys(o).length)) {
          ...
          if (l && e.currentBreakpoint !== l) {
            ...
            var u = d || e.originalParams,
                ...
                v = s.enabled;
            c && !p ? (a.removeClass(s.containerModifierClass + "multirow " + s.containerModifierClass + "multirow-column"), e.emitContainerClasses()) : !c && p && (a.addClass(s.containerModifierClass + "multirow"), (u.slidesPerColumnFill && "column" === u.slidesPerColumnFill || !u.slidesPerColumnFill && "column" === s.slidesPerColumnFill) && a.addClass(s.containerModifierClass + "multirow-column"), e.emitContainerClasses());
            var f = u.direction && u.direction !== s.direction,
                h = s.loop && (u.slidesPerView !== s.slidesPerView || f);
            f && i && e.changeDirection(), E(e.params, u);
            var m = e.params.enabled;
            E(e, {
              allowTouchMove: e.params.allowTouchMove,
              allowSlideNext: e.params.allowSlideNext,
              allowSlidePrev: e.params.allowSlidePrev
            }), v && !m ? e.disable() : !v && m && e.enable(), e.currentBreakpoint = l, e.emit("_beforeBreakpoint", u), h && i && (e.loopDestroy(), e.loopCreate(), e.updateSlides(), e.slideTo(t - n + e.loopedSlides, 0, !1)), e.emit("breakpoint", u);
          }
        }
      },
        ...
        if (void 0 === t && (t = "window"), e && ("container" !== t || i)) {
          ...
          for (var l = 0; l < o.length; l += 1) {
            var d = o[l],
                u = d.point,
                c = d.value;
            "window" === t ? n.matchMedia("(min-width: " + c + "px)").matches && (r = u) : c <= i.clientWidth && (r = u);
          }
    ...
    classes: Y,
    images: {
      loadImage: function loadImage(e, t, i, r, n, a) {
        var o,
            l = s();
        ...
        w(e).parent("picture")[0] || e.complete && n ? d() : t ? ((o = new l.Image()).onload = d, o.onerror = d, r && (o.sizes = r), i && (o.srcset = i), t && (o.src = t)) : d();
      },
    ...
    function e() {
      ...
      if (1 === n.length && n[0].constructor && "Object" === Object.prototype.toString.call(n[0]).slice(8, -1) ? i = n[0] : (t = n[0], i = n[1]), i || (i = {}), i = E({}, i), t && !i.el && (i.el = t), i.el && w(i.el).length > 1) {
        var a = [];
        return w(i.el).each(function (t) {
          var r = E({}, i, {
            el: t
          });
          a.push(new e(r));
      ...
      var l,
          d,
          u = E({}, U);
      return o.useParams(u), o.params = E({}, u, Q, i), o.originalParams = E({}, o.params), o.passedParams = E({}, i), o.params && o.params.on && Object.keys(o.params.on).forEach(function (e) {
        o.on(e, o.params.on[e]);
      }), o.params && o.params.onAny && o.onAny(o.params.onAny), o.$ = w, E(o, {
    ...
    return n.enable = function () {
      ...
      if (t.centeredSlides) {
        for (var o, l = i[s].swiperSlideSize, d = s + 1; d < i.length; d += 1) {
          i[d] && !o && (a += 1, (l += i[d].swiperSlideSize) > n && (o = !0));
        }

        for (var u = s - 1; u >= 0; u -= 1) {
          i[u] && !o && (a += 1, (l += i[u].swiperSlideSize) > n && (o = !0));
        }
      } else for (var c = s + 1; c < i.length; c += 1) {
        r[c] - r[s] < n && (a += 1);
      }
      ...
      var n = function n() {
        ...
        if (e && e.shadowRoot && e.shadowRoot.querySelector) {
          var t = w(e.shadowRoot.querySelector(n()));
      ...
      if (0 === s.length && t.params.createElements) {
        ...
        s = w(a), a.className = t.params.wrapperClass, i.append(a), i.children("." + t.params.slideClass).each(function (e) {
          s.append(e);
        });
      }
  ...
  var ie = {
    ...
    update: function update() {
      ...
      if (!e.params.loop) {
        var r = e.navigation,
            n = r.$nextEl,
            s = r.$prevEl;
        s && s.length > 0 && (e.isBeginning ? i(s, !0) : i(s, !1), e.params.watchOverflow && e.enabled && s[e.isLocked ? "addClass" : "removeClass"](t.lockClass)), n && n.length > 0 && (e.isEnd ? i(n, !0) : i(n, !1), e.params.watchOverflow && e.enabled && n[e.isLocked ? "addClass" : "removeClass"](t.lockClass));
      }
    },
    ...
    init: function init() {
      ...
      i.params.navigation = function (e, t, i, n) {
        var s = r();
  ...
  var re = {
    ...
    on: {
      ...
      click: function click(e, t) {
        ...
        if (e.params.navigation.hideOnClick && !w(s).is(n) && !w(s).is(r)) {
  ...
  ee.use([re]), function (e) {
    var t = new Image();
    t.onload = t.onerror = function () {
      !function (e) {
        var t = !0 === e ? "webp" : "no-webp";
  ...
  var ne = document.querySelector(".nav__open");
  ne.addEventListener("click", function () {
    ne.classList.toggle("open"), document.body.classList.toggle("hidden");
  });
})();